<x-app-layout>
    <x-slot name="title">Tambah Menu Baru</x-slot>
    ...
    <div class="max-w-2xl">
        <x-card>
            <form action="{{ route('menus.store') }}" method="POST">
                ...
                <x-input name="name" label="Nama Menu" placeholder="Contoh: Nasi Goreng Spesial" :value="old('name')"
                    required />
                ...
                <x-input name="price" type="number" label="Harga (Rp)" placeholder="15000" :value="old('price')"
                    step="0.01" min="0" required />

                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_available" value="1"
                            {{ old('is_available', true) ? 'checked' : '' }} class="mr-2">
